...
import { fetchLatestQuestions, fetchTopHelpers, fetchFeaturedSubjects } from '../../firebase/firebase'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/requests" className="text-blue-600 hover:text-blue-700 flex items-center gap-1">
